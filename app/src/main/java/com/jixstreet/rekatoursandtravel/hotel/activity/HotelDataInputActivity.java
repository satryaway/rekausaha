...
public class HotelDataInputActivity extends AppCompatActivity {
    ...
    View.OnClickListener onNextBtnClickedListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (isValidated()) {
                ...
                final AlertDialog.Builder alertDialog = new AlertDialog.Builder(HotelDataInputActivity.this);
    ...
    View.OnTouchListener onNationalityTouchedListener = new View.OnTouchListener() {
        ...
        public boolean onTouch(View v, MotionEvent motionEvent) {
            if (MotionEvent.ACTION_UP == motionEvent.getAction()) {
                AlertDialog.Builder builder = new AlertDialog.Builder(HotelDataInputActivity.this);
    ...
    private void addOrder() {
        ...
        client.get(url, requestParams, new JsonHttpResponseHandler() {
            ...
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                Toast.makeText(HotelDataInputActivity.this, R.string.RTO, Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse) {
                Log.e("JSON PASSANGER", errorResponse + "");
                ErrorException.getError(HotelDataInputActivity.this, errorResponse);
            }
        });
    }
    ...
    private void showAlertDialog(String message, final String status) {
        final android.app.AlertDialog alertDialog = new android.app.AlertDialog.Builder(
                HotelDataInputActivity.this).create();
    ...
    private void nextActivity() {
        Intent intent = new Intent(HotelDataInputActivity.this, ListOrderActivity.class);
